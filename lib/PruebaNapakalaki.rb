...
################################################################################
puts "Monsters with a level greater than 10:\n"

var = 0

while (var < monsters.length)
  if(monsters[var].combat_level > 10)
    puts monsters[var].name 
  end
  var+=1
end
puts "------------------------------------------------------------------\n"
puts "Monsters with a bad consequence that only causes losing levels:\n"
var1 = 0
while (var1 < monsters.length)
  if(monsters[var1].bc.levels > 0 && monsters[var1].bc.n_visible_treasures == 0 && monsters[var1].bc.n_hidden_treasures == 0)
    puts monsters[var1].name 
  end
  var1+=1
end

puts "------------------------------------------------------------------\n" 
puts"Monsters with a prize that levels up more than 1 level:\n"
var2 = 0
while (var2 < monsters.length)
  if(monsters[var2].pz.level > 1)
    puts monsters[var2].name 
  end
  var2+=1
end

puts "------------------------------------------------------------------\n"
puts "Monsters whose bad consequence causes the loss of certain treasures," 
puts "whether they are visible or hidden:\n"
var3 = 0
while (var3 < monsters.length)
  if(monsters[var3].bc.n_visible_treasures > 0 || monsters[var3].bc.n_hidden_treasures > 0)
    puts monsters[var3].name 
  end
  var3+=1
end
